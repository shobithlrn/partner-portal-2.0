...
! function(e) {
    ...
    s.DEFAULTS = {
        ...
        this.$element.trigger(s), this.isShown = !0, this.$element.hide(), this.$text.show(), this.$icon.find("i").removeClass("mdi-eye " + this.options.eyeOpenClass).addClass("mdi-eye-off " + this.options.eyeCloseClass), this.$text[this.options.placement](this.$element)
    }, s.prototype.hide = function(t) {
        var s = e.Event("hide.bs.password", {
            relatedTarget: t
        });
        this.$element.trigger(s), this.isShown = !1, this.$element.show(), this.$text.hide(), this.$icon.find("i").removeClass("mdi-eye-off " + this.options.eyeCloseClass).addClass("mdi-eye " + this.options.eyeOpenClass), this.$element[this.options.placement](this.$text)
